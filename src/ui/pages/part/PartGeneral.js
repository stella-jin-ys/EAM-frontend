        ...
        return (
            <div style={{width: "100%", marginTop: 0}}>
                ...
                <EAMSelect
                    ...
                    <EAMInput
                        children={children}
                        elementInfo={{...partLayout.fields['udfchar02'], readonly: true}}
                        value={part.userDefinedFields.udfchar02}
                        updateProperty={updatePartProperty}
                        valueKey="userDefinedFields.udfchar02"/>

                    <EAMInput
                        children={children}
                        elementInfo={{...partLayout.fields['udfchar01'], readonly: true}}
                        value={part.userDefinedFields.udfchar01}
                        updateProperty={updatePartProperty}
