...
function PartUsageDialog(props) {
  ...
  let initNewPartUsage = (workorder) => {
    ...
    WSWorkorders.getInitNewPartUsage(workorder)
      .then((response) => {
        setLoading(false);
  ...
  let handleSave = () => {
    ...
    const relatedWorkOrder =
      props.equipmentMEC && props.equipmentMEC.length > 0
        ? props.workorder.number
        : null;
        ...
        <DialogContent id="content" style={overflowStyle}>
          <div>
            <BlockUi tag="div" blocking={loading || props.isLoading}>
              ...
              <EAMSelect
                elementInfo={{ ...props.tabLayout["activity"], attribute: "R" }}
              ...
              >
                <EAMAutocomplete
                  elementInfo={props.tabLayout["partcode"]}
              ...
              >
                <EAMAutocomplete
                  elementInfo={props.tabLayout["assetid"]}
              ...
              <EAMSelect
                elementInfo={props.tabLayout["bincode"]}
                valueKey="bin"
                values={binList}
              ...
              <EAMInput
                elementInfo={props.tabLayout["transactionquantity"]}
