...
function AddActivityDialog(props) {
  ...
  let init = () => {
    ...
    WSWorkorders.getTypesOfHours().then((response) =>
      setTypesOfHours(response.body.data)
    );
  };
        ...
        <DialogContent id="content">
          <div>
            <BlockUi tag="div" blocking={loading}>
              ...
              {/*   <EAMAutocomplete children={props.children}
                                elementInfo={props.layout.employee}
                                value={props.workorderNumber.assignedTo}
                                updateProperty={updateWorkorderProperty}
                                valueKey="assignedTo"
                                valueDesc={props.workorderNumber.assignedToDesc}
