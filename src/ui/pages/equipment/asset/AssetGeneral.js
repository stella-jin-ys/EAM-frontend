    ...
    render() {
        ...
        return (
            <div style={{width: "100%", marginTop: 0}}>
                ...
                <EAMInput
                        children = {children}
                        elementInfo={{...assetLayout.fields['udfchar04'],readonly:true}}
                        value={equipment.userDefinedFields.udfchar04}
                        updateProperty={updateEquipmentProperty}
                        valueKey="userDefinedFields.udfchar04"/>

                        <EAMInput
                        children = {children}
                        elementInfo={{...assetLayout.fields['udfchar05'],readonly:true}}
                        value={equipment.userDefinedFields.udfchar05}
                        updateProperty={updateEquipmentProperty}
                    ...
                    {/*<EAMInput
                        children = {children}
                        elementInfo={assetLayout.fields['udfchar39']}
                        value={equipment.userDefinedFields.udfchar39}
                        updateProperty={updateEquipmentProperty}
                        valueKey="userDefinedFields.udfchar39"/>*/}

                    {/*<EAMInput
                        children = {children}
                        elementInfo={assetLayout.fields['chessid']}
                        value={equipment.chessid}
                        updateProperty={updateEquipmentProperty}
                        valueKey="chessid"
                     />*/}
