        ...
        return (
            <EISPanel heading="HIERARCHY">
                <div style={{width: "100%", marginTop: 0}}>
                    ...
                    <EAMInput
                        children={children}
                        elementInfo={{...positionLayout.fields['udfchar02'], readonly: true}}
                        value={equipment.userDefinedFields.udfchar02}
                        updateProperty={updateEquipmentProperty}
                        valueKey="userDefinedFields.udfchar02"/>
                    <EAMInput
                        children={children}
                        elementInfo={{...positionLayout.fields['udfchar03'], readonly: true}}
                        value={equipment.userDefinedFields.udfchar03}
                        updateProperty={updateEquipmentProperty}
                        valueKey="userDefinedFields.udfchar03"/>
