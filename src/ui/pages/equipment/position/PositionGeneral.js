    ...
    render() {
        ...
        return (
            <div style={{width: "100%", marginTop: 0}}>
                ...
                <EAMInput
                        children = {children}
                        elementInfo={{...positionLayout.fields['udfchar01'], readonly: true}}
                        value={equipment.userDefinedFields.udfchar01}
                        updateProperty={updateEquipmentProperty}
                        valueKey="userDefinedFields.udfchar01"
                    />
                    <EAMInput
                        children = {children}
                        elementInfo={{...positionLayout.fields['udfchar04'], readonly: true}}
