...
class EquipmentToolbar extends Component {
    ...
    emailEquipmentHandler() {
        window.open("mailto:?Subject=" + this.props.entityDesc + " Code " + this.props.equipment.code + "&body=http://www.eam.esss.lu.se/eam-light/equipment/" + this.props.equipment.code, '_self');
