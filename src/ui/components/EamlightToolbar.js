    ...
    renderDesktopMenu() {
        return (
            <div style={{display: "flex", height: 36}}>
                ...
                <Button onClick= {this.props.assignHandler}
                // <Button onClick={() => this.assignConfirmation.show()}
                            disabled={this.isAssignedButtonDisabled()}
                            startIcon={<AssignmentIcon className="iconButton"/>}
                >
                    Assigned To
                </Button>
