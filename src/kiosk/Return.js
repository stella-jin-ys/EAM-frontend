  ...
  const clickSearch = () => {
    if (issueInputs.workorder === "") {
      ...
      /*  Promise.all([
        ...
        setActivities(res[1].body.data);
        console.log(activities, res[1].body.data);
        setIssueInputs((prev) => ({
          ...prev,
      ...
      fetch(`http://localhost:3001/orders/${woInput}`)
    ...
    <div>
      {currentPage ? (
        ...
        <div className={classes.root}>
          <Typography variant="h6">Return part(s) for:</Typography>
